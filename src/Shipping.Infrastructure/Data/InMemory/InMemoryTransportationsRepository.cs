...
public class InMemoryTransportationsRepository : ITransportationsRepository
{
    ...
    [
        new()
        {
            Id = Guid.Parse("a7d8f9f0-a1b2-4c3d-8e5f-6a7b8c9d0e1f"),
        ...
        new()
        {
            Id = Guid.Parse("e7d8e9f0-a1b2-4c3d-8e5f-6b7b8c9d0e1f"),
            DriverId = Guid.Parse("e7d8e9f0-a1b2-4c3d-8e5f-6a7b8c9d0e1f"),
        ...
        new()
        {
            ...
            RouteId = Guid.Parse("b1a2c3d4-e5f6-7890-a1a2-a3a4k5a6a7a8"),
        ...
        new()
        {
            ...
            RouteId = Guid.Parse("e1f2d3c-4b5a-6d7e-8f9c-0a0b1c2d3e4f5"),
